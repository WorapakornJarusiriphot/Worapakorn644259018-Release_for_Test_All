...
*** Test Cases ***
TC 20001 ทดสอบการสมัครสมาชิกด้วยข้อมูลที่ถูกต้อง
    ...
    ${username}=    Set Variable    worapakorn${current_datetime}
    ${email}=    Set Variable    worapakorn${current_datetime}@gmail.com
...
TC 20002 ทดสอบการสมัครสมาชิกโดยไม่กรอกข้อมูล
...
TC 20003 ทดสอบการสมัครสมาชิกด้วยอีเมลที่ไม่ถูกต้อง
    [Documentation]    ทดสอบการสมัครสมาชิกด้วยอีเมลที่ไม่ถูกต้อง
    [Tags]    registration    negative
    ${current_datetime}=    Get Current Date    result_format=%Y%m%d%H%M%S
    ${username}=    Set Variable    worapakorn${current_datetime}
    ${email}=    Set Variable    worapakorn.invalid.com
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Input Text    id=firstName    วรปกร
    Input Text    id=lastName    จารุศิริพจน์
...
TC 20004 ทดสอบการสมัครสมาชิกด้วย E-mail หรือ Username ซ้ำกับในฐานข้อมูล
...
TC 20005 ตรวจสอบการสมัครสมาชิกด้วย Username ซ้ำ
...
TC 20006 ตรวจสอบการสมัครสมาชิกด้วย Password ที่ไม่ถูกต้อง
...
TC 20007 ตรวจสอบการสมัครสมาชิกด้วย Phone Number ที่ไม่ถูกต้อง
...
TC 20008 ตรวจสอบการสมัครสมาชิกด้วยวันเกิดที่ไม่ถูกต้อง
