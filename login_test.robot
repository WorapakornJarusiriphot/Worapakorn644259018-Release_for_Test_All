...
TC 10002 ทดสอบการเข้าสู่ระบบเมื่อกรอก E-mail หรือ Username ผิด
...
TC 10003 ทดสอบการเข้าสู่ระบบเมื่อกรอก Password ผิด
...
TC 10004 ทดสอบการเข้าสู่ระบบโดยไม่กรอกข้อมูล
...
TC 10005 ทดสอบการเข้าสู่ระบบเมื่อกรอก Username ผิด
    [Documentation]    ทดสอบการเข้าสู่ระบบด้วย Username ที่ผิด
    [Tags]    login    negative
    Open Browser    ${URL}    chrome
    Maximize Browser Window
    Input Text    id=identifier    wrongusername
    Input Text    id=password    wrongpassword
    Wait Until Element Is Visible    xpath=//button[@type="submit"]    1s
    Click Button    xpath=//button[@type="submit"]
